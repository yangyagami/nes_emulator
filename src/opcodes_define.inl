...
std::map<std::string, std::function<void(OPCODE &)>> opcode_functions_ = {
  // Offical
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("RTS", CPU::Return),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BRK", CPU::Break),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("JSR", CPU::JumptoSubRoutine),
  ...
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("LDY", CPU::LoadToY),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("TXS", CPU::TransXToStackPointer),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("TXA", CPU::TransferXToA),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BCS", CPU::BranchWhenCarryFlagSet),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BNE", CPU::BranchIfNotEqual),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BEQ", CPU::BranchIfEqual),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BPL", CPU::BranchIfPositive),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("JMP", CPU::Jump),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("DEC", CPU::Decrement),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("DEX", CPU::DecrementX),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("DEY", CPU::DecrementY),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("INX", CPU::IncrementX),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("INY", CPU::IncrementY),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("INC", CPU::Increment),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("STX", CPU::StoreFromX),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("STY", CPU::StoreFromY),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("CMP", CPU::Compare),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("CPX", CPU::CompareX),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("CPY", CPU::CompareY),

  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("BIT", CPU::Bit),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("ORA", CPU::BitwiseORWithAccumulator),
  NES_EMULATOR_OPCODES_DEFINE_FUNCTION_BIND("AND", CPU::BitwiseANDWithAccumulator),
};
